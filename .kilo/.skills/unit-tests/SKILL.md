...
Run the tests after any Python modification. The cams-dl-project is unit tested with a
coverage above 95 %, so every code change should be validated by the existing tests
